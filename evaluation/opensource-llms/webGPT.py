...
def main():
    ...
    device_type : str, optional
            The type of the device to run on. It could be one of "cpu", "cuda", "ipu", "xpu",
            "mkldnn", "opengl", "opencl", "ideep", "hip", "ve", "fpga", "ort", "xla", "lazy",
            "vulkan", "mps", "meta", "hpu", "mtia". Default is "cuda".
    )
    """
    device_type = "cuda"
