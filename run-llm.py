...
from method.models import generate_llm_values
from method.ours.utils import create_driver, get_xpath, interact_with_input, wait_for_elements
...
def timed_execute(func, timeout=5):
...
try:
    ...
    get_form = lambda: driver.find_elements(By.TAG_NAME, 'form')[1]

    html = driver.find_element(By.TAG_NAME, 'html').get_attribute('outerHTML')
    form = timed_execute(get_form)
